...
Current version: **1.1.1** (`pyproject.toml` + `src/maxim/__init__.py`; PyPI: https://pypi.org/project/pymaxim/ — `main` is ahead of PyPI by policy, §Versioning). 1.1.1 is the **"Enforcement"** release: roadmap item 16.1–16.9 turned the score card's honesty claims into lints, CI steps and tests. The 1.1 "Sensorimotor" line: items 17 (Exp 52) and 19 (Exp 53b) DONE; item 18 → 1.1.2. This line is checked by `scripts/lint_version_sync.py` — bump it in the release transaction. Active theme **1.1 "Sensorimotor"**. The roadmap index is [docs/plans/README.md](docs/plans/README.md); the roadmap through 1.3 is [docs/plans/roadmap_1_1_to_1_3.md](docs/plans/roadmap_1_1_to_1_3.md); behavioral-graduation gates live in [docs/plans/behavioral_graduation_candidates.md](docs/plans/behavioral_graduation_candidates.md). Deferred plans (revive on trigger): [docs/plans/deferred/](docs/plans/deferred/). Shipped-history through 2026-04 (the old "Recently shipped" ledger): [docs/lessons/active-initiatives-history-2026.md](docs/lessons/active-initiatives-history-2026.md).
