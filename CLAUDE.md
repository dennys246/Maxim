...
| Temporal credit | `decisions/temporal_credit.py` (**TemporalCreditDistributor** — NAc+SCN composition, phase-similarity fallback, goal credit), `time/temporal_event.py` (TemporalEvent envelope), `decisions/valence_signal.py` (ValenceSignal transport for WMS salience modulation) |
