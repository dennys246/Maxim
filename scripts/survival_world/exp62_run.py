...
def classify_g2(fields: dict[str, Any], *, arm: str, floor: float) -> dict[str, Any]:
    ...
    * otherwise → the training left no readable fear, and the caller refuses the row.
    ...
    out: dict[str, Any] = {
        ...
        # the margin the read resolved BY — the gate records how it landed, not only that it did
        "read_margin": g2.get("probe_margin"),
        "read_shore_margin": g2.get("shore_margin"),
