...
- **Bump rules:**
  ...
  - **Major** (`0.x → 1.0.0`) — reserved for the version that demonstrably improves on a task across sessions without fine-tuning the underlying LLM, with a test that proves it. See [plans/percept_substrate_plan.md](plans/percept_substrate_plan.md).
