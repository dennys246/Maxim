...
- **[biosystem_unification.md](biosystem_unification.md) Wave 2 (MemoryHub):** Stage 3 (pain/salience spike) needs the PainBus → episode-capture bridge. If Wave 2 ships the MemoryHub unification first, Stage 3 can wire through MemoryHub's existing capture callback surface. If this plan ships first, it builds a minimal bridge that Wave 2 later absorbs.
