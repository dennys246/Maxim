...
2. **Stage 0c — DUAL-KEY self_effect.** `self_effect: {head_yaw: ±0.3, azimuth: ∓0.17}` (big: ±0.9 / ∓0.50). Keeps joint-space bookkeeping, adds the drive-bearing key at gain-calibrated deltas matching the Exp 45c decision boundary.
