...
> the survival-world line ([survival_world_1_3.md](survival_world_1_3.md), designed post-1.2)
...
| **1.2** | **Oasis** | The four-arm sharing benchmark, pre-registered, run in Minecraft at n ≥ 50, replicated on two Reachy Minis at n = 12; gates 3, 4 and 8. **Plus the poison-resistance slice (added 2026-09-05, instrument + mechanism, NO claim):** tighten-only merge + the inherent bias class riding the V1–V10 ingestion adapter, and **Gauntlet #3** (coding-safety battery) as the Queen-promotion instrument — [coding_habits_oasis.md](coding_habits_oasis.md) §4; sequencing in §"The 1.2 poison-resistance slice" below. The ship gate is unchanged by this addition | The gate ladder below |
| **1.3** | **"Oasis-2" — the survival world** (rescoped 2026-09-09) | The survival loop (R2's 3 breaks) + the survival world with marked classrooms + **the survival reflex tier** (Phase 1b — innate startle/flee below deliberation, gated `[engineering]`) + the headline **shared survival wants**. R1 (generalization) and R4 (delayed credit) are the frontier mechanics gating the rich classrooms (crafting, farming, wolf upkeep). Full phased plan + dependency markers: **[roadmap_1_3.md](roadmap_1_3.md)**; designs: [survival_world_1_3.md](survival_world_1_3.md), [intrinsic_motivation_1_3.md](intrinsic_motivation_1_3.md); benchmark Part II: [minecraft_benchmark.md](minecraft_benchmark.md) | Pivotal may-fail (shared-survival-want / R3 survival benchmark). Platform: modern MC (1.20.1), re-verify sensors first. |
| **1.4** | **Working title "Anticipation"** — re-pointed 2026-09-18 ([roadmap_1_4.md](roadmap_1_4.md)); "Shared perception" DEFERRED on a physical trigger (a second body), plan intact | Richer video/audio — cochlear front-end, vision encoder, binding, three-factor calibration — **plus sharing at the perception layer**, the **DN-canonical *orienting* reflex** (perception-coupled; stays here, distinct from 1.3's survival reflex), **the microduck** ([microduck_intent_layer.md](microduck_intent_layer.md)), **Exp 55** ([coding_habits_oasis.md](coding_habits_oasis.md) §6), and **breeding** (deferred from 1.3) | Its own pivotal experiment (Stage 0c); shared-perception inherits R1's transfer bound. **SEQUENCING: [roadmap_1_3_path.md](roadmap_1_3_path.md)** — Stage A duck baseline → Stage B engine seam / robot factory → Stage C fabric |
...
[coding_habits_oasis.md](coding_habits_oasis.md) is **named by this item**. What 1.2 gets:
