...
| 6 | H1 healthy-hardware re-characterization | **DONE** — base session 2026-08-08 + the `_big` delivered-shift block 2026-08-24 (n=8/side, 0.943 of command both sides; `_big` YAML magnitudes stay frozen, right-side Δaz asymmetry filed as a follow-up). |
