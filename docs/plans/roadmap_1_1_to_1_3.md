...
| **1.3** | **"Oasis-2" — the survival world** *(rescoped 2026-09-09)* | Learning reward FROM the game: the survival loop (R2's 3 breaks), the survival world with marked classrooms (dining hall, dark=danger, wolf defense), and the headline — **shared *survival* wants** (an agent shares a hard-learned survival want; the receiver survives its first night). Phased plan: [roadmap_1_3.md](roadmap_1_3.md); designs: [survival_world_1_3.md](survival_world_1_3.md) + [intrinsic_motivation_1_3.md](intrinsic_motivation_1_3.md) | **High — pivotal may-fail (shared-survival-want / R3 benchmark).** |
| **1.4** | **Perception fabric + reflex tier + microduck** *(was 1.3; moved 2026-09-09)* | Cochlear front-end, vision encoder, binding, three-factor calibration, DN-canonical orienting reflex — **plus the microduck** ([microduck_intent_layer.md](microduck_intent_layer.md)), **Exp 55** (aversion/coding-habit transfer), and **breeding** (husbandry population dynamics, deferred from 1.3). Sequencing: [roadmap_1_3_path.md](roadmap_1_3_path.md) (now the 1.4 plan) | **High — its own pivotal may-fail (Stage 0c).** |
...
| **1.3** | **"Oasis-2" — the survival world** (rescoped 2026-09-09) | The survival loop (R2's 3 breaks) + the survival world with marked classrooms + the headline **shared survival wants**. R1 (generalization) and R4 (delayed credit) are the frontier mechanics gating the rich classrooms (crafting, farming, wolf upkeep). Full phased plan + dependency markers: **[roadmap_1_3.md](roadmap_1_3.md)**; designs: [survival_world_1_3.md](survival_world_1_3.md), [intrinsic_motivation_1_3.md](intrinsic_motivation_1_3.md); benchmark Part II: [minecraft_benchmark.md](minecraft_benchmark.md) | Pivotal may-fail (shared-survival-want / R3 survival benchmark). Platform: modern MC (1.20.1), re-verify sensors first. |
| **1.4** | Perception fabric + reflex tier + microduck (**was 1.3; moved 2026-09-09**) | Cochlear front-end, vision encoder, binding, three-factor calibration — **plus the microduck** ([microduck_intent_layer.md](microduck_intent_layer.md)) — **plus Exp 55** ([coding_habits_oasis.md](coding_habits_oasis.md) §6) — **plus breeding** (husbandry population dynamics, deferred from 1.3) | Its own pivotal experiment. **SEQUENCING: [roadmap_1_3_path.md](roadmap_1_3_path.md)** — Stage A duck baseline → Stage B engine seam / robot factory → Stage C fabric |
