...
5. **Release transaction — split 2026-08-25:**
   ...
   - **5b (after item 17 — DONE; item 18 → 1.1.1; item 19 — Exp 53 recorded outcome, added 2026-08-26): `1.1.0` final** — the bump (#547) and the website audit (#548, maxim-web #7) are DONE 2026-08-26; publication waits on item 19. Then: audit the canonical website against
