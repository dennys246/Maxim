...
| O11 | **Security cluster — SCHEDULED into 1.3.1 (2026-09-26)** (2026-09-23) | Six verified defects and one suspected ([#826](https://github.com/dennys246/Maxim/issues/826)), in two families: the sandbox ([#800](https://github.com/dennys246/Maxim/issues/800) scripts never run, [#801](https://github.com/dennys246/Maxim/issues/801) prefix containment, [#802](https://github.com/dennys246/Maxim/issues/802) runs the path not the approved content) and mode/approval ([#828](https://github.com/dennys246/Maxim/issues/828) any audio can say "maxim singularity" — highest, [#827](https://github.com/dennys246/Maxim/issues/827), #826), plus [#824](https://github.com/dennys246/Maxim/issues/824) DNS rebinding. | Each issue closes itself; this row goes when the last does. |
...
| O14 | **Two ingest defects the format freeze surfaced — SCHEDULED into 1.3.1** (2026-09-26) | [#914](https://github.com/dennys246/Maxim/issues/914): `rekey_nac_state` folds colliding clusters by overwrite and keeps the inherent marker on a learned bias. [#913](https://github.com/dennys246/Maxim/issues/913): `nac_merge` drops the receiver's own context-distinct links on every ingest (607 → 443 on a real state, empty donor). | Both issues closed ([roadmap_1_3_x.md](roadmap_1_3_x.md) §"Added by the re-scope"). |
