...
| M6 | **Pain intensity:** fixed, one gain for every source (tier 2, no learned gain) | Tier 2 with a learned gain: per-source habituation to harmless pain and sensitisation to damaging pain, bounded above zero | [adaptive_nociception.md](adaptive_nociception.md)'s trigger: chronic non-damaging pain in a world, or measured over-tagging from repeated pain. |
