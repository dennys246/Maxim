...
> **ARCHIVED 2026-09-19** (plans audit at the 1.3.0 release): its design shipped (`rekey_nac_state`, 1.1.3) and 1.3.0 extended the same seam for `cluster_fear`. Kept as the record of what was decided and why; not a live plan.
