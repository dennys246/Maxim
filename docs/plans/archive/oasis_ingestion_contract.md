...
> **ARCHIVED 2026-09-19** (plans audit at the 1.3.0 release): adopted and implemented (`hivemind/ingest.py`, the V1–V10 adapter). Kept as the record of what was decided and why; not a live plan.
...
that order ([coding_habits_oasis.md](../deferred/coding_habits_oasis.md) §4;
...
Defined in [coding_habits_oasis.md](../deferred/coding_habits_oasis.md) §4; this PR ships the
