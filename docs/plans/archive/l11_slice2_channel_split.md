...
> **ARCHIVED 2026-09-19** (plans audit at the 1.3.0 release): DO-NOT-BUILD verdict; the line closed with `cosine-separation-is-directional` as the operative model. Kept as the record of what was decided and why; not a live plan.
...
(`docs/plans/archive/l11_world_channel_diagnostic.md`). **Nothing here authorizes a build** — it is the
