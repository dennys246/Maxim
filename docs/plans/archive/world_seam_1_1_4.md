...
> **ARCHIVED 2026-09-19** (plans audit at the 1.3.0 release): its work shipped as 1.1.4 “The world seam”; the seam itself is documented in `docs/agents/simulation-experiments.md` and `minecraft_benchmark.md`. Kept as the record of what was decided and why; not a live plan.
