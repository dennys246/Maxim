...
> **ARCHIVED 2026-09-19** (plans audit at the 1.3.0 release): its design shipped as 1.3.0 “Oasis-2”; the living plans are `roadmap_1_3.md` and `roadmap_1_4.md`. Kept as the record of what was decided and why; not a live plan.
...
> [intrinsic_motivation_1_3.md](../deferred/intrinsic_motivation_1_3.md). This section keeps the WORLD
...
- **Novelty must ignite-then-fade, not stay flat (correction to "each combo equally novel").**
  ...
  [intrinsic_motivation_1_3.md](../deferred/intrinsic_motivation_1_3.md), context-keyed on `(craft_action,
