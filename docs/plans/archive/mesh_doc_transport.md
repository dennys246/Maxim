...
> **ARCHIVED 2026-09-19** (plans audit at the 1.3.0 release): no revive trigger (README: “No trigger = archive”). Kept as the record of what was decided and why; not a live plan.
...
**Target version:** Roadmap stage C9 (see [reactive_peer_mesh_roadmap.md](../deferred/reactive_peer_mesh_roadmap.md) §4). No hard release gate — parallel to C4/C5/C6, probably slots into 0.5 or 0.6 depending on when multi-agent coordination becomes a user-visible blocker.
...
- [reactive_peer_mesh_roadmap.md](../deferred/reactive_peer_mesh_roadmap.md) §4 Stage C9 — this plan's home in the roadmap
