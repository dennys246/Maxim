...
> **ARCHIVED 2026-09-19** (plans audit at the 1.3.0 release): superseded by `roadmap_1_3_x.md` §1.3.2, which scopes the decomposition to `agent_loop.py` with behaviour-preservation gates. Kept as the record of what was decided and why; not a live plan.
