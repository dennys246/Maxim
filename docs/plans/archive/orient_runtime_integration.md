...
> **⛔ SUPERSEDED — Landing 1 shipped as `../deferred/live_audio_orient_wiring.md` Stages 0b–4b (PRs #402/#411); Landings 2–3 are `../deferred/hybrid_substrate_reflex_runtime.md` (the 1.3 reflex tier). The header's "Target: 1.1" was false.**

**Status:** DRAFT plan (2026-07-16). Turns [Layer 1](../deferred/substrate_native_orienting.md) —
...
- **It is the Layer-2 prerequisite**: spatial co-activation of sound + sight + word at a
  ...
  measurement ([`MAXIM_EC_TRACE_ACTIVATIONS=1`](../deferred/substrate_native_orienting.md) Phase 3b)
...
> **Merged (2026-07-17):** Landing 2 (the reflex) is the same work as the hybrid substrate-primary reconciliation — designed in [hybrid_substrate_reflex_runtime.md](../deferred/hybrid_substrate_reflex_runtime.md), which supersedes this section's sketch.
...
- Layer 1 result: [substrate_native_orienting.md](../deferred/substrate_native_orienting.md) ·
