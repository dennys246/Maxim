...
> **ARCHIVED 2026-09-19** (plans audit at the 1.3.0 release): the L11 channel-split line closed (Slice 1 ran, Step C was killed); the surviving result is the negative one, kept here and in `docs/limits/`. Kept as the record of what was decided and why; not a live plan.
