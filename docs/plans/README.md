...
- [sem_learning_loop.md](sem_learning_loop.md) — **SHIPPED** (PR #143, 2026-04-17). Complete SEM → bio-pipeline learning loop: cerebellum activation in BioStack, `distribute_reward` wiring, success reactions, pain spike episode boundary. Absorbs cerebellum_activation.md, valence annotation Stage 4, episode boundary enrichment Rule 3.
...
- [substrate_valence_annotation.md](substrate_valence_annotation.md) — **Stages 1-3 SHIPPED** (PR #143, 2026-04-17). Reaction capture → edge valence → spreading activation propagation. Stage 4 absorbed into sem_learning_loop.md.
