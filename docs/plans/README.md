...
- [quality_burndown.md](quality_burndown.md) — **the quality burndown** (2026-09-10, renamed 2026-09-20): the incremental-improvement track that runs *alongside* the survival build — cheap guards + claim-truth + small correctness fixes chipping at the weakest 1.1/1.2 score-card grades. Optional (nothing `Stale`/`Broken`); batched by PR.
