...
**Status:** Active protocol — runs after [llm_path_fast_failover.md](../../plans/archive/llm_path_fast_failover.md) ships, before [llm_path_operator_visibility.md](../../plans/archive/llm_path_operator_visibility.md) scope is finalized
...
- [llm_path_operator_visibility.md](../../plans/archive/llm_path_operator_visibility.md) **NOT** required — this protocol runs without Plan 4's admin API; observability comes from JSONL logs + `lane_metrics.metrics_snapshot()`
