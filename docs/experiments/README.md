...
| [37_cross_session_graduation.md](37_cross_session_graduation.md) | Exp 37 | 2026-05-30 (pre-reg) | pre-registered, in flight | **PRIMARY 1.0 GATE.** Cross-session behavioral delta (fire avoidance) — cradle + Exp 37 harness. Metric pivoted to `positive_approach_engagement_fraction` (plan: [exp37_metric_pivot.md](../plans/exp37_metric_pivot.md)). Statistical test swapped to SD-shift (plan: [exp37_sd_shift.md](../plans/exp37_sd_shift.md)). Decision pending trial execution. |
