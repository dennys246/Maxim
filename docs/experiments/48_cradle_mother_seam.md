...
**Status:** **SUPERSEDED 2026-08-25 by [Exp 52](52_nurture.md)** (relief-sourced credit on the shuffled apparatus v3: GRADUATE — taught 0.878 / satiated 0.441 / no_feed 0.413); retained as the apparatus case study, and the PARTIAL verdict below stands for the constant-credit apparatus it measured. Original: **COMPLETE — NOT GRADUATED, the pre-registered PARTIAL branch** (verdict 2026-08-14 on the apparatus-v2 re-baseline; explore-weight sweep complete 2026-08-18). Pre-registered 2026-07-23, after the extero/intero multi-modality seam (PR #411, `26d8f901`).
